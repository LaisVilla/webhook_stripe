        ...
        messageDiv.innerHTML = `
            <div class="flex items-start space-x-3">
                <div class="flex-shrink-0">
                    <div class="h-8 w-8 rounded-lg bg-gradient-to-r ${isUser ? 'from-tertiary to-secondary' : 'from-primary to-secondary'} flex items-center justify-center">
                        <i class="lucide ${isUser ? 'lucide-user' : 'lucide-bot'} text-white h-5 w-5"></i>
                    </div>
                </div>
                <div class="flex-1">
